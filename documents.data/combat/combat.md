...
* [Underwater Combat](/combat/underwater_combat/)description: Rules for making an attack from the 5th Edition (5e) SRD (System Reference Document).
...
description: Rules for combat underwater from the 5th Edition (5e) SRD (System Reference Document).
